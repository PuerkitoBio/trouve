...
describe "Trouve::CircularBuffer" do
  ...
  it "has a size of 0 by default" do
    create_with([] of Int32).size.should eq(0)
  end
  ...
  it "can push a value" do
    create_with([1]).size.should eq(1)
  end
  ...
  it "can push two values" do
    create_with([1, 2]).size.should eq(2)
  end
  ...
  it "can push three values" do
    create_with([1, 2, 3]).size.should eq(3)
  end
  ...
  it "rotates when pushing more than the capacity" do
    create_with([1, 2, 3, 4]).size.should eq(3)
  end
  ...
  it "rotates when pushing two more than the capacity" do
    create_with([1, 2, 3, 4, 5]).size.should eq(3)
  end
  ...
  it "rotates when pushing three more than the capacity" do
    create_with([1, 2, 3, 4, 5, 6]).size.should eq(3)
  end
  ...
  it "rotates when pushing four more than the capacity" do
    create_with([1, 2, 3, 4, 5, 6, 7]).size.should eq(3)
  end
